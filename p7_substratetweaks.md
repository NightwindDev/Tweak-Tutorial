...
Then finally, we would have to "convert" the Objective-C method we are hooking to the C function that every Objective-C method gets "translated" to.
...
// TODO: explain the %subclass wrapper
// Maybe something else I'm forgetting, idk
